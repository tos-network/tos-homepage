...
const translations = {
  en: {
    ...
    'features.smartcontract.title': 'Smart Contract Ready',
    'features.smartcontract.desc': 'Native smart contract support powered by Solana\'s sBPF execution engine. Develop with Tolang, a Solidity-compatible language that brings familiar syntax to TOS. Build DeFi applications, NFTs, and complex dApps with high performance and low costs.',
  ...
  zh: {
    ...
    'features.smartcontract.title': '智能合约就绪',
    'features.smartcontract.desc': 'Solana sBPF 虚拟机，支持 Tolang 语言。用于复杂智能体逻辑和 DeFi 应用的高性能智能合约。',
  ...
  ja: {
    ...
    'features.smartcontract.title': 'スマートコントラクト対応',
    'features.smartcontract.desc': 'Solana sBPF仮想マシン、Tolang言語サポート。複雑なエージェントロジックとDeFiアプリケーションのための高性能スマートコントラクト。',
  ...
  ko: {
    ...
    'features.smartcontract.title': '스마트 컨트랙트 준비',
    'features.smartcontract.desc': 'Solana sBPF 가상 머신, Tolang 언어 지원. 복잡한 에이전트 로직 및 DeFi 애플리케이션을 위한 고성능 스마트 컨트랙트.',
