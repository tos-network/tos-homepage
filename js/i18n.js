...
const translations = {
  en: {
    ...
    'features.coreTitle': 'Core Infrastructure for AGI Economy',
  ...
  zh: {
    ...
    'features.coreTitle': 'AGI 经济的核心基础设施',
  ...
  ja: {
    ...
    'features.coreTitle': 'AGI経済のためのコアインフラストラクチャ',
  ...
  ko: {
    ...
    'features.coreTitle': 'AGI 경제를 위한 핵심 인프라',
