...
const translations = {
  en: {
    ...
    // Features Section
    'features.subtitle': 'Powered by BlockDAG consensus with 10,000 TPS and 1-second blocks. Verifiable identity (DID), intelligent work settlement (AGIW), compute/energy credits (CC/EC), and self-governance—the complete economic infrastructure for autonomous agents at unprecedented speed. Built for the AGI era.',
    ...
    'features.blockdag.title': 'BlockDAG Consensus',
    'features.blockdag.desc': 'Revolutionary BlockDAG architecture based on the BlockDAG protocol. Unlike traditional blockchains, parallel blocks coexist and are ordered in consensus—eliminating orphaned blocks and enabling unprecedented scalability without sacrificing security or decentralization.',
    ...
    'features.pow.desc': 'Pure, stake-less proof-of-work combined with BlockDAG consensus provides Bitcoin-level security guarantees. Fully decentralized and permissionless—anyone can participate in mining and securing the network without staking requirements.',
    ...
    'features.takovm.desc': 'Built on battle-tested Linux eBPF technology powering billions of devices worldwide. The same proven foundation running in Fortune 500 companies\' production systems now powers your smart contracts. Unmatched reliability for a blockchain built to last a century.',
    ...
    'features.referral.title': 'Native Referral System',
    'features.referral.desc': 'Unleash your leadership potential and grow your community exponentially. Build powerful networks with automated multi-tier rewards, real-time team tracking, and instant profit sharing. The ultimate growth engine for visionary community builders.',
    'features.kyc.title': 'Chain-Native KYC Compliance',
    'features.kyc.desc': 'The gold standard for global DeFi compliance. Seamlessly bridge traditional finance and blockchain with institutional-grade verification. Future-proof your project for worldwide adoption while protecting user privacy.',
    'features.qrpayment.title': 'QR Code Instant Payments',
    'features.qrpayment.desc': 'Bring blockchain to everyday life. Scan, pay, done — in just 3 seconds. From coffee shops to global commerce, experience the seamless fusion of crypto convenience and real-world utility. The future of payments is already here.',

    // NEW: 10 Additional Features
    'features.agiprotocol.title': 'AGI Protocol',
    'features.agiprotocol.desc': 'Let AI agents become true economic citizens. Own identity, build reputation, manage assets—your AI is no longer just a tool, but a digital employee that creates value independently. The infrastructure for the agent economy starts here.',
    'features.a2aprotocol.title': 'A2A Protocol',
    'features.a2aprotocol.desc': 'AI talks directly to AI—collaborate, negotiate, transact. No middlemen, automatic task escrow, instant settlement on completion. Usher in the new era of machine economy where value flows between agents as naturally as breathing.',
    'features.batchtransfer.title': 'Native Batch Transfer',
    'features.batchtransfer.desc': 'One transaction, 500 addresses, instant delivery. Airdrops, dividends, payroll—operations that once took hours now need just one click. Save 50% on fees, boost efficiency 100x.',
    'features.vrfrandom.title': 'Native VRF Random',
    'features.vrfrandom.desc': 'Truly fair on-chain randomness—unpredictable and tamper-proof. Lottery draws, NFT mystery boxes, game loot—at just 1% the cost of competitors, with 100% fairness guaranteed.',
    'features.scheduledtasks.title': 'Native Scheduled Tasks',
    'features.scheduledtasks.desc': 'Let the blockchain work for you automatically. Timed draws, auto-compound, vesting unlocks—set once, execute forever. Say goodbye to third-party services, save 90% on automation costs.',
    'features.mevprotection.title': 'MEV Protection',
    'features.mevprotection.desc': 'Say goodbye to sandwich attack fears. Transactions execute in arrival order, reducing attack success from 90% to under 5%. On TOS, every penny you trade stays yours.',
    'features.atomicswap.title': 'Atomic Swap',
    'features.atomicswap.desc': 'Peer-to-peer trading with zero slippage, zero trust risk. Large trades without getting rekt, cross-chain swaps without centralized bridges. True decentralized exchange becomes reality.',
    'features.crosschainbridge.title': 'Cross-Chain Bridge',
    'features.crosschainbridge.desc': 'Assets flow freely between TRON, BSC, and Ethereum. Multi-signature security, smart limits for risk control. One bridge connecting the entire crypto universe.',
    'features.nftsupport.title': 'Native NFT Support',
  ...
  zh: {
    ...
    'features.blockdag.title': 'BlockDAG 共识',
    'features.blockdag.desc': '基于 BlockDAG 协议的革命性 BlockDAG 架构。并行区块共存并在共识中排序——消除孤块，实现前所未有的可扩展性。',
    ...
    'features.pow.desc': '纯粹的、无质押的工作量证明结合 BlockDAG 共识，提供比特币级别的安全保障。完全去中心化和无许可——任何人都可以参与挖矿。',
    'features.trilemma.title': '区块链三难困境已解决',
    'features.trilemma.desc': 'TOS 通过 BlockDAG 创新架构同时实现可扩展性、安全性和去中心化。在任何维度都不妥协。',
    ...
    'features.takovm.desc': '基于久经考验的 Linux eBPF 技术，驱动全球数十亿设备。财富500强企业生产系统所采用的同一可靠基石，如今为您的智能合约保驾护航。无与伦比的可靠性，奠定 TOS 区块链百年霸业的根基。',
    ...
    'features.referral.title': '链原生推荐系统',
    'features.referral.desc': '释放你的领袖潜能，让社区指数级增长！自动化多层奖励、实时团队追踪、即时收益分配。打造属于你的商业帝国，让每一次分享都创造价值。社区领袖的终极增长引擎。',
    'features.kyc.title': '链原生KYC合规',
    'features.kyc.desc': '全球DeFi合规的黄金标准。无缝连接传统金融与区块链世界，让链上金融走得更远、更稳、更合规。为你的项目插上通往全球市场的翅膀，同时守护用户隐私。',
    'features.qrpayment.title': 'QR码即时支付',
    'features.qrpayment.desc': '让区块链融入日常生活。扫码、支付、完成——仅需3秒。从街边咖啡店到跨境商务，体验加密货币与现实世界的无缝融合。支付的未来，触手可及。',

    // NEW: 10 Additional Features
    'features.agiprotocol.title': 'AGI 协议',
    'features.agiprotocol.desc': '让 AI 智能体成为真正的经济公民。拥有身份、积累声誉、管理资产——您的 AI 不再只是工具，而是能独立创造价值的数字员工。智能体经济的基础设施，从这里开始。',
    'features.a2aprotocol.title': 'A2A 协议',
    'features.a2aprotocol.desc': 'AI 与 AI 直接对话、协作、交易。无需中间人，任务自动托管，完成即结算。开启机器经济的新纪元，让智能体之间的价值流动如同呼吸般自然。',
    'features.batchtransfer.title': '原生批量转账',
    'features.batchtransfer.desc': '一笔交易，500个地址，瞬间到账。空投、分红、工资发放——曾经需要数小时的操作，现在只需一次点击。节省50%手续费，效率提升100倍。',
    'features.vrfrandom.title': '原生 VRF 随机数',
    'features.vrfrandom.desc': '真正公平的链上随机数，无法预测、不可操控。博彩开奖、NFT盲盒、游戏抽奖——成本仅为竞品的1%，公平性提升至100%。',
    'features.scheduledtasks.title': '原生定时任务',
    'features.scheduledtasks.desc': '让区块链自动为你工作。定时开奖、自动复投、锁仓解锁——设定一次，永久执行。告别第三方服务，省去90%自动化成本。',
    'features.mevprotection.title': 'MEV 保护',
    'features.mevprotection.desc': '告别被"夹子"收割的恐惧。交易按到达顺序执行，三明治攻击成功率从90%降至5%以下。在TOS上交易，您的每一分钱都属于自己。',
    'features.atomicswap.title': '原子交换',
    'features.atomicswap.desc': '点对点交易，零滑点、零信任风险。大额交易不再担心被割，跨链兑换无需中心化桥。真正的去中心化交易，从此成为现实。',
    'features.crosschainbridge.title': '跨链桥',
    'features.crosschainbridge.desc': '资产自由穿梭于 TRON、BSC、以太坊之间。多重签名守护安全，智能限额防控风险。一座桥，连接整个加密世界。',
    'features.nftsupport.title': '原生 NFT 支持',
  ...
  ja: {
    ...
    'features.blockdag.title': 'BlockDAGコンセンサス',
    'features.blockdag.desc': 'BlockDAGプロトコルに基づく革命的なBlockDAGアーキテクチャ。並列ブロックが共存し、コンセンサスで順序付けされ、孤立ブロックを排除し、前例のないスケーラビリティを実現します。',
    ...
    'features.pow.desc': '純粋な、ステーク不要のProof-of-WorkとBlockDAGコンセンサスを組み合わせ、ビットコインレベルのセキュリティ保証を提供します。完全に分散化され、許可不要—誰でもマイニングに参加できます。',
    'features.trilemma.title': 'ブロックチェーントリレンマを解決',
    'features.trilemma.desc': 'TOSはBlockDAGの革新的なアーキテクチャを通じて、スケーラビリティ、セキュリティ、分散化を同時に実現します。どの次元でも妥協しません。',
    ...
    'features.takovm.desc': '世界中の数十億台のデバイスを動かす、実戦で鍛えられたLinux eBPF技術を基盤に構築。フォーチュン500企業の本番システムで採用されている同じ信頼の基盤が、あなたのスマートコントラクトを支えます。100年続くブロックチェーンのための、比類なき信頼性。',
    ...
    'features.referral.title': 'ネイティブリファラルシステム',
    'features.referral.desc': 'あなたのリーダーシップを解き放ち、コミュニティを爆発的に成長させましょう。自動化されたマルチティア報酬、リアルタイムチーム追跡、即時収益分配。すべてのシェアが価値を生み出す、ビジョナリーリーダーのための究極の成長エンジン。',
    'features.kyc.title': 'チェーンネイティブKYCコンプライアンス',
    'features.kyc.desc': 'グローバルDeFiコンプライアンスのゴールドスタンダード。従来の金融とブロックチェーンをシームレスに橋渡しし、オンチェーン金融の未来を切り拓く。世界市場への扉を開きながら、ユーザープライバシーも守ります。',
    'features.qrpayment.title': 'QRコード即時決済',
    'features.qrpayment.desc': 'ブロックチェーンを日常に。スキャン、支払い、完了——わずか3秒。街角のカフェから国際取引まで、暗号資産と現実世界がシームレスに融合。決済の未来は、もうここにあります。',

    // NEW: 10 Additional Features
    'features.agiprotocol.title': 'AGIプロトコル',
    'features.agiprotocol.desc': 'AIエージェントを真の経済市民に。アイデンティティを持ち、評判を築き、資産を管理——あなたのAIはもはや単なるツールではなく、独立して価値を創造するデジタル従業員です。エージェント経済のインフラストラクチャは、ここから始まります。',
    'features.a2aprotocol.title': 'A2Aプロトコル',
    'features.a2aprotocol.desc': 'AIがAIと直接対話し、協力し、取引する。仲介者不要、タスクは自動エスクロー、完了と同時に即時決済。呼吸のように自然に価値がエージェント間を流れる、機械経済の新時代を切り開きます。',
    'features.batchtransfer.title': 'ネイティブ一括送金',
    'features.batchtransfer.desc': '1トランザクションで500アドレスへ即時送金。エアドロップ、配当、給与支払い——かつて数時間かかった作業が、今やワンクリック。手数料50%節約、効率100倍向上。',
    'features.vrfrandom.title': 'ネイティブVRF乱数',
    'features.vrfrandom.desc': '予測不可能で改ざん不可能な、真に公平なオンチェーン乱数。抽選、NFTミステリーボックス、ゲームガチャ——競合の1%のコストで、100%の公平性を保証。',
    'features.scheduledtasks.title': 'ネイティブスケジュールタスク',
    'features.scheduledtasks.desc': 'ブロックチェーンに自動で働いてもらいましょう。定時抽選、自動複利、ベスティング解除——一度設定すれば永久に実行。サードパーティサービス不要、自動化コスト90%削減。',
    'features.mevprotection.title': 'MEV保護',
    'features.mevprotection.desc': 'サンドイッチ攻撃の恐怖にさようなら。トランザクションは到着順に実行され、攻撃成功率は90%から5%未満に低下。TOSでの取引では、あなたの1円1円があなたのもの。',
    'features.atomicswap.title': 'アトミックスワップ',
    'features.atomicswap.desc': 'スリッページゼロ、信頼リスクゼロのピアツーピア取引。大口取引でも損しない、中央集権型ブリッジなしのクロスチェーン交換。真の分散型取引所が現実に。',
    'features.crosschainbridge.title': 'クロスチェーンブリッジ',
    'features.crosschainbridge.desc': 'TRON、BSC、イーサリアム間で資産が自由に流通。マルチシグがセキュリティを守り、スマートリミットがリスクを制御。一つの橋で、暗号資産の世界全体をつなぐ。',
    'features.nftsupport.title': 'ネイティブNFTサポート',
  ...
  ko: {
    ...
    'features.blockdag.title': 'BlockDAG 합의',
    'features.blockdag.desc': 'BlockDAG 프로토콜 기반의 혁명적인 BlockDAG 아키텍처. 병렬 블록이 공존하고 합의에서 순서가 지정되어 고아 블록을 제거하고 전례 없는 확장성을 실현합니다.',
    ...
    'features.pow.desc': '순수한 스테이크 없는 Proof-of-Work와 BlockDAG 합의를 결합하여 비트코인 수준의 보안 보장을 제공합니다. 완전히 분산되고 무허가—누구나 마이닝에 참여할 수 있습니다.',
    'features.trilemma.title': '블록체인 트릴레마 해결',
    'features.trilemma.desc': 'TOS는 BlockDAG의 혁신적인 아키텍처를 통해 확장성, 보안, 분산화를 동시에 달성합니다. 어떤 차원에서도 타협하지 않습니다.',
    ...
    'features.takovm.desc': '전 세계 수십억 대의 디바이스를 구동하는, 실전에서 검증된 Linux eBPF 기술 기반으로 구축. Fortune 500대 기업의 프로덕션 시스템에서 채택된 동일한 신뢰의 기반이 당신의 스마트 컨트랙트를 지원합니다. 100년을 이어갈 블록체인을 위한 비교할 수 없는 신뢰성.',
    ...
    'features.referral.title': '네이티브 리퍼럴 시스템',
    'features.referral.desc': '당신의 리더십 잠재력을 발휘하고 커뮤니티를 폭발적으로 성장시키세요. 자동화된 다단계 보상, 실시간 팀 추적, 즉각적인 수익 분배. 모든 공유가 가치를 창출하는, 비전을 가진 리더를 위한 궁극의 성장 엔진.',
    'features.kyc.title': '체인 네이티브 KYC 컴플라이언스',
    'features.kyc.desc': '글로벌 DeFi 컴플라이언스의 골드 스탠다드. 전통 금융과 블록체인을 원활하게 연결하여 온체인 금융의 미래를 열어갑니다. 사용자 프라이버시를 보호하면서 글로벌 시장으로 가는 문을 열어드립니다.',
    'features.qrpayment.title': 'QR 코드 즉시 결제',
    'features.qrpayment.desc': '블록체인을 일상으로. 스캔, 결제, 완료——단 3초. 동네 카페에서 글로벌 커머스까지, 암호화폐와 현실 세계의 완벽한 융합을 경험하세요. 결제의 미래는 이미 여기에 있습니다.',

    // NEW: 10 Additional Features
    'features.agiprotocol.title': 'AGI 프로토콜',
    'features.agiprotocol.desc': 'AI 에이전트를 진정한 경제 시민으로. 신원을 소유하고, 평판을 쌓고, 자산을 관리——당신의 AI는 더 이상 도구가 아닌, 독립적으로 가치를 창출하는 디지털 직원입니다. 에이전트 경제의 인프라는 여기서 시작됩니다.',
    'features.a2aprotocol.title': 'A2A 프로토콜',
    'features.a2aprotocol.desc': 'AI가 AI와 직접 대화하고, 협력하고, 거래합니다. 중개자 없이, 작업은 자동 에스크로, 완료 즉시 정산. 호흡처럼 자연스럽게 에이전트 간에 가치가 흐르는 머신 경제의 새 시대를 열어갑니다.',
    'features.batchtransfer.title': '네이티브 일괄 전송',
    'features.batchtransfer.desc': '한 트랜잭션으로 500개 주소에 즉시 전송. 에어드롭, 배당금, 급여 지급——수 시간 걸리던 작업이 원클릭으로. 수수료 50% 절감, 효율성 100배 향상.',
    'features.vrfrandom.title': '네이티브 VRF 난수',
    'features.vrfrandom.desc': '예측 불가능하고 조작 불가능한 진정한 공정한 온체인 난수. 추첨, NFT 미스터리 박스, 게임 가챠——경쟁사의 1% 비용으로 100% 공정성 보장.',
    'features.scheduledtasks.title': '네이티브 스케줄 작업',
    'features.scheduledtasks.desc': '블록체인이 자동으로 일하게 하세요. 정시 추첨, 자동 복리, 베스팅 해제——한 번 설정하면 영원히 실행. 서드파티 서비스 불필요, 자동화 비용 90% 절감.',
    'features.mevprotection.title': 'MEV 보호',
    'features.mevprotection.desc': '샌드위치 공격의 공포에 안녕을. 트랜잭션은 도착 순서대로 실행되어 공격 성공률이 90%에서 5% 미만으로 감소. TOS에서의 거래는 당신의 모든 자산이 당신의 것.',
    'features.atomicswap.title': '아토믹 스왑',
    'features.atomicswap.desc': '슬리피지 제로, 신뢰 리스크 제로의 P2P 거래. 대량 거래도 손해 없이, 중앙화 브릿지 없이 크로스체인 교환. 진정한 탈중앙화 거래소가 현실이 됩니다.',
    'features.crosschainbridge.title': '크로스체인 브릿지',
    'features.crosschainbridge.desc': 'TRON, BSC, 이더리움 간에 자산이 자유롭게 이동. 멀티시그로 보안을 지키고, 스마트 리밋으로 리스크를 제어. 하나의 브릿지로 전체 암호화폐 우주를 연결.',
    'features.nftsupport.title': '네이티브 NFT 지원',
